import { BadRequestException, Body, Controller, Delete, HttpCode, HttpStatus, Param, Put } from '@nestjs/common';
...
export class VotesController {
  ...
  async remove(@Param('reviewId') reviewId: string, @CurrentUser() user: AuthenticatedUser): Promise<void> {
